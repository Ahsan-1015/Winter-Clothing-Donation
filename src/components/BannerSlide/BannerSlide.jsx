...
//   const slides = [
//     {
//       image: 'https://media.gettyimages.com/id/596815111/photo/college-volunteers-hosting-a-food-drive-in-campus.jpg?s=612x612&w=0&k=20&c=CMO5aiWIOEyxdn0BaGjzGVf4c1niEcthk8zhGHhmauM=',
...
//     },
//     {
//       image: 'https://plus.unsplash.com/premium_photo-1661963855053-eb37e5ce9e2b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8Y2xvdGglMjBkb25hdGUlMjBwb29yJTIwY2hpbGQlMjB3aW50ZXJ8ZW58MHx8MHx8fDA%3D',
//       title: 'MAKE A DIFFERENCE',
//       description:
//         'Your donation helps provide warmth to those suffering from the cold. Every item counts in making someone\'s day better.',
//     },
//     {
//       image: 'https://imgstaticcontent.lbb.in/lbbnew/wp-content/uploads/sites/1/2015/12/soundofhope-600x400.jpg',
...
//                 >
//                   <h1 className="text-3xl lg:text-4xl font-extrabold">{slide.title}</h1>
//                   <p className="mt-4 text-sm lg:text-base text-gray-300">{slide.description}</p>
//                 </div>
//               </div>
//             </SwiperSlide>
//           ))}
...
//       {/* Sidebar with clickable profile images */}
//       <div className="hidden lg:block lg:w-1/4 flex flex-col items-center space-y-4 p-4">
//         {slides.map((slide, index) => (
//           <div
//             key={index}
//             onClick={() => handleSlideChange(index)} // Change slide on click
